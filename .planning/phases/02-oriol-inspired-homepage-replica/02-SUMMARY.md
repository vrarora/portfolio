...
The homepage now reads as a close Oriol-inspired editorial replica on desktop and remains usable on mobile.
It includes the temporary `Vaibhav Arora` wordmark, the placeholder hero headline, floating icon navigation, resume/social affordances, three placeholder work cards, an about section, contact links, and a footer resume link.
...
- Rendered sections confirmed: header, hero, proof cards, 3 work rows, 3 about/principle cards, 5 contact links, and footer.
